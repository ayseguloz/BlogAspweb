<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="BlogAsp.WebForm1" %>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#education">Eğitimlerim</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container-fluid p-0">
                    ...
                    <div class="my-auto">
                        ...
                        <div class="resume-item d-flex flex-column flex-md-row mb-5">
                            <div class="resume-content mr-auto">
                                ...
                                <p>
                                    <asp:Label ID="Label9" runat="server" Text='<%#Eval("ACİKLAMA") %>'></asp:Label>
                                </p>
                            </div>
                ...
                <ItemTemplate>
                    <div class="my-auto">
                        ...
                        <div class="resume-item d-flex flex-column flex-md-row mb-5">
                            <div class="resume-content mr-auto">
                                <h3 class="mb-0">
                                    <asp:Label ID="Label11" runat="server" Text='<%#Eval("BASLİK") %>'></asp:Label></h3>
                                <div class="subheading mb-3">
                                    <asp:Label ID="Label12" runat="server" Text='<%#Eval("ALTBASLİK") %>'></asp:Label>
                                </div>
                                <div>
            ...
            <div class="my-auto">
                ...
                <ul class="fa-ul mb-0">
                    <li>
                        ...
                        <asp:Label ID="Label18" runat="server" Text="iş akışı"></asp:Label></li>
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="awards">
            <div class="my-auto">
                <h2 class="mb-5">Belgeler &amp; Sertifikalar</h2>
                <asp:Repeater ID="Repeater6" runat="server">
                    <ItemTemplate>
                        <ul class="fa-ul mb-0">
                            <li>
                                <i class="fa-li fa fa-trophy text-warning"></i>
                                <asp:Label ID="Label17" runat="server" Text='<%#Eval("BELGELER") %>'></asp:Label></li>
                        </ul>
                    </ItemTemplate>
                </asp:Repeater>
            </div>
